...
},{"./src/js/main":19}],14:[function(require,module,exports){
'use strict';
...
},{"../../lib/dom":15,"../../lib/helper":18,"../instances":30,"../update-geometry":31,"../update-scroll":32}],25:[function(require,module,exports){
'use strict';
...
},{"../lib/class":14,"../lib/dom":15,"../lib/event-manager":16,"../lib/guid":17,"../lib/helper":18,"./default-setting":20}],31:[function(require,module,exports){
'use strict';
...
},{"./bootstrap.js":64,"./pulse/app.js":66,"./pulse/pulse.js":71,"jquery":8,"perfect-scrollbar":13,"tether":35}],66:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        logout: function logout() {
            ...
            _user2.default.logout(function () {
                ...
                return _this.$route.router.go({ name: 'login' });
            });
        }
    },
    ...
    events: {
        ...
        "user:loggedout": function userLoggedout() {
            //Log the user out
            this.logout();
        },
...
},{"./services/ls":74,"./stores/shared.js":75,"./stores/user.js":76,"vue":62,"vue-hot-reload-api":36}],68:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        ...
        login: function login() {
            ...
            _user2.default.login(this.email, this.password, function (response) {
                //Reset the form
                _this.email = "";
                _this.password = "";
...
exports.default = {
     ...
     */
    state: {
        currentUser: _user2.default.current
    },
    ...
    init: function init() {
        ...
        //Initialize
        return _http2.default.get('users/initialize', {}, function (response) {
            ...
            _user2.default.init(_this.currentUser);
...
},{"../services/http":73,"./user":76}],76:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    login: function login(email, password) {
        ...
        _http2.default.post('users/authorize', { email: email, password: password }, function (response) {
            if (successCb) {
                successCb(response);
            }
        }, errorCb);
...
},{"../services/http":73,"../stubs/user":77,"nprogress":12}],77:[function(require,module,exports){
"use strict";
