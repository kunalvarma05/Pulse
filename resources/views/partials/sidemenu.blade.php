<nav class="sidemenu">
    ...
    <ul class="nav sidemenu-user-accounts">
        <li>
            <a class="sidemenu-user-account" href="#" style="animation-delay: .5s;">
                <img src="https://randomuser.me/api/portraits/med/men/14.jpg">
            </a>
        </li>
        <li>
            <a class="sidemenu-user-account" href="#" style="animation-delay: .6s;">
                <img src="https://randomuser.me/api/portraits/med/men/19.jpg">
            </a>
        </li>
        <li>
            <a class="sidemenu-user-account active" href="#" style="animation-delay: .7s;">
                <img src="https://randomuser.me/api/portraits/med/men/9.jpg">
            </a>
        </li>
        <li>
            <a class="sidemenu-user-account" href="#" style="animation-delay: .8s;">
